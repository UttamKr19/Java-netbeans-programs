...
class EmployeeDB {
	...
	public String showPaySlip(int empId) {
		...
		for (Employee e : employeeDb) {
			if (e.getEmpId() == empId) {
				paySlip = "Pay slip for employee id "
                                        + empId + " is " + e.getEmpSalary();
			}
		}
...
public class Q2_g {
	...
	public static void main(String[] args) {
		...
		Employee emp1 = new Employee(101, "Uttam", "u@g.com", 'M', 25000);
		Employee emp2 = new Employee(102, "Gaurav", "grv@g.com", 'F', 30000);
		Employee emp3 = new Employee(103, "Akash", "a@ak.com", 'M', 20000);
		Employee emp4 = new Employee(104, "Sayanto", "say@g.com", 'M', 50000);
