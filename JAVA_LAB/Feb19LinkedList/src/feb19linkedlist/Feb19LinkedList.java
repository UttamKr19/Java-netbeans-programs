...
public class Feb19LinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n-----------------------------");
        System.out.println("==> After appending another list");
        ...
        //removeLastOccurence
        System.out.println("\n--------------------------");
        System.out.println("==>remove Last occurence of bello");
        arr.removeLastOccurrence("bello");
        System.out.println(arr);
        //clear
        System.out.println("\n-----------------------------");
        arr.clear();
