 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ws.me.com/", wsdlLocation = "http://localhost:34250/WebApplication1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ws.me.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:34250/WebApplication1/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ws.me.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.me.com/", "NewWebServicePort"), NewWebService.class, features);
    }
