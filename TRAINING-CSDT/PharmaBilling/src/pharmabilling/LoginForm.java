...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Gautami", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Uttam\\Documents\\PMS icon.png")); // NOI18N

        jPanel3.setBackground(new java.awt.Color(102, 0, 102));

        jPanel2.setBackground(new java.awt.Color(27, 85, 154));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Uttam\\Documents\\login-icon-png-21 - Copy.png")); // NOI18N
        jLabel4.setText(" ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String str="select *from LOGINMASTER where USERNAME='"+txtName.getText()+"' and PASSWORD='"+txtPass.getText()+"' ";
            ResultSet rs=st.executeQuery(str);
            if(rs.next())
            {
                JOptionPane.showMessageDialog(null,"Login Successfully");
                HomeMaster fh=new HomeMaster();
                fh.show();
                this.hide().;
